...
namespace ForecastWizardApplication.Views
{
    public partial class LookUpTableForm : Form
    {
        ...
        public int SiteID;
        public int PlantObjectTypeID;
        public int ObjectID;
        public LookUpTableForm(int LookUpTableID, int SiteID, int PlantObjectTypeID, int ObjectID)
        {
            InitializeComponent();
            this.LookUpTableID = LookUpTableID;
            this.SiteID = SiteID;
            this.PlantObjectTypeID = PlantObjectTypeID;
