...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            sessionStorage.setItem('function', 'UpdateOptimizer');
    ...
    <div class="container" ng-app="myApp" ng-controller="heatChartController">
        <div class="row">
            <div class="col-lg-12 dvBlock">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-3" style="margin-top: 100px">
                        <div class="col-lg-11">
                                ...
                                <div class="form-group">
                                    <div class="radio">
                                        <label class="radio-inline control-label">
                                            <input type="radio" name="amount" ng-checked="!RTOptimization" ng-click="OptimizationRT('MaximizeNetPower')">
                                    ...
                                    <div class="radio">
                                        <label class="radio-inline control-label">
                                            <input type="radio" id="amount_25" name="amount" ng-checked="RTOptimization" value="" ng-click="OptimizationRT('MinimizeHeatRate')">
                    ...
                    <div class="col-lg-9 col-md-7 col-sm-7">
                        ...
                        <div class="col-lg-12">
                            <div id="container1" style="height: 150px;"></div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-5" style="margin-top: 100px">
                        <div class="col-lg-11">
                            ...
                            <form class="form-inline" role="form" style="margin-left: 10px;">
                                <div class="form-group">
                                    <div class="radio">
                                        <label class="radio-inline control-label">
                                            <input type="radio" id="amount_26" name="amount" ng-checked="!DAOptimization" value="" ng-click="OptimizationDA('MaximizeNetPower')">
                                            Maximize Net Power Output
                                        </label>
                                    </div>
                                    ...
                                    <div class="radio">
                                        <label class="radio-inline control-label">
                                            <input type="radio" id="amount_26" name="amount" ng-checked="DAOptimization" value="" ng-click="OptimizationDA('MinimizeHeatRate')">
                                            Minimize Net Heat Rate
                                        </label>
                ...
                <div class="col-lg-3 col-lg-offset-5">
                    ...
                    <div class="col-lg-12" style="margin-bottom: 10px;">
                        <div class="col-lg-5">
                            <input type="submit" class="btn btn-default" data-toggle="modal" value="Update" data-target="#myModal1" ng-click="UpdateOptimizer()" />
                        </div>
