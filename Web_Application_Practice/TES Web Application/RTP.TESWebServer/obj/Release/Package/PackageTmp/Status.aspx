                        ...
                        <div ng-repeat="val in status.Chiller2 track by $index">
                            <table class="tbl">
                                <tr>
                                    ...
                                    <td style="width: 30%" ng-repeat="txtBoxChil2 in val.textbox">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 dvBlock" ng-controller="operatorController">
                ...
                <div class="col-md-12" style="height: 361px">
                    ...
                    <table class="tbl">
                        <tr ng-repeat="val in status.TESTank track by $index">
                            <td style="width: 40%">
                                <span class="txtMain">{{val.lable}}</span>
                            </td>

                            <td style="width: 30%" ng-repeat="txtBoxThermal in val.textbox track by $index">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-9 col-md-9">
                            ...
                            <div class="scale-margin-left">
                                <table>
                                    <tr style="cursor: pointer">
                                        <td class="boxClassBelow" ng-repeat="value in chillerSeries track by $index" ng-class="selectedBoxIndex == $index ? 'selectedBoxLower':''">{{value}}
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="scale-margin-left">
                                <table>
                                    <tr style="cursor: pointer">
                                        <td class="boxClassBelow" ng-repeat="value in secondaryPumpsSeries track by $index" ng-class="selectedBoxIndex == $index ? 'selectedBoxLower':''">{{value}}
                                        </td>
                                    </tr>
                                </table>
                            </div>
